...
const ContactForm = () => {
  return (
    <div className="bg-black rounded-lg p-4 sm:p-10">
      <h1 className="text-pink-500 text-2xl md:text-3xl lg:text-[2.5rem] font-bold">
        Let&apos;s Work together!
      </h1>
      ...
      <form className="mt-8 w-full block overflow-hidden">
        ...
        ></textarea>
        <div className="mt-4">
          <button className="bg-pink-500 px-8 py-3.5 text-white hover:bg-pink-700 transition-all duration-200 rounded-full font-semibold">Send Message</button>
        </div>
      </form>
    </div>
  );
